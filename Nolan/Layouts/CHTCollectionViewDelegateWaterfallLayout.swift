...
//funcao que sobreescreve "t" e compara dois valores e retorna uma boleana
...
//funcao que sobreescreve "><" e compara dois valores e retorna uma boleana
private func > <T: Comparable>(lhs: T?, rhs: T?) -> Bool {
    switch (lhs, rhs) {
    case let (l?, r?):
        return l > r
...
//Aplicando protocolos da collection view
